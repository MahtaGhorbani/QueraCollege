...
if __name__ == '__main__':
    ...
    parser.add_argument('-ml', '--map_location', nargs='+', dest='map_location', type=str, required=False,
                        help='Latitude and Longitude of Map (Northing, Easting)', default=['2.0', '17.0'])
